...
static const std::string encodePath = resultDir + "encode.js";
static const std::string decodePath = resultDir + "decode.js";
...
void RunEncodeBenchmark()
{
  ...
  DumpJsonResult(encodePath, results, "encode_result");
...
void RunDecodeBenchmark()
{
  ...
  // print sorted summary
  DumpJsonResult(decodePath, results, "decode_result");
}
